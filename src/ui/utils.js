...
export function saveSVG(svg){
	console.log(svg);
	saveAs(URL.createObjectURL(new Blob([svg.data], { type: 'image/svg+xml' })), `${svg.name}.svg`);
}
...
export function copyToClipboard(text) {
	...
	} else { // Fallback for older browsers (less likely to be needed in Figma plugins)
